...
link-citations: yes
documentclass: jdf
# classoption: a4paper # Use A4 paper size
classoption: letterpaper # Use US letter paper size
output: 
    pdf_document:
        template: jdf-template.pandoc
        fig_caption: true
        keep_tex: true
csl: apa-sort-by-first-author-family-name-with-citation-number.csl
---
